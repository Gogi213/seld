...
module.exports = {
  ...
  INTERVALS: {
    ...
    DATA_CALCULATION: 2 * 1000, // каждые 2 секунды (было 10)
    BROADCAST: 2 * 1000, // каждые 2 секунды (было 15)
    STATS_LOG: 5 * 60 * 1000, // каждые 5 минут
    API_REQUEST_DELAY: 50, // задержка между API запросами (было 100)
    SIGNAL_CHECK: 1 * 1000 // каждую секунду проверяем сигналы
  },
